...
curl -w "\nhttp code: %{http_code} - content size %{size_download}\n" "http://127.0.0.1:9180/apisix/admin/upstreams/notification" -H "X-API-KEY: edd1c9f034335f136f87ad84b625c8f1" -X PUT -d '
...
curl -w "\nhttp code: %{http_code} - content size %{size_download}\n" "http://127.0.0.1:9180/apisix/admin/upstreams/auth" -H "X-API-KEY: edd1c9f034335f136f87ad84b625c8f1" -X PUT -d '
